...
@AnalyzeClasses(packages = "edu.hm.hafner.pitmute", importOptions = DoNotIncludeTests.class)
final class PackageArchitectureTest {
    ...
    static final ArchRule ADHERES_TO_PACKAGE_DESIGN
            = classes().should(adhereToPlantUmlDiagram(PACKAGE_DESIGN, consideringOnlyDependenciesInAnyPackage("edu.hm.hafner.pitmute")));
